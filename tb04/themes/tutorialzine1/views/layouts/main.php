...
<html>
    ...
    <body>
                ...
                <nav class="clear" id="mainmenu"> <!-- The nav link semantically marks your main site navigation -->
						<?php $this->widget('zii.widgets.CMenu',array(
							'items'=>array(
								...
								array('label'=>'รายงาน', 'url'=>array('/site/report')),
        ...
        <footer> <!-- Marking the footer section -->
           <div class="line"></div>
           <p>Copyright 2013 - Kaimintsoft.com</p> <!-- Change the copyright notice -->
           <a href="#" class="up">Go UP</a>
           <a href="http://www.kaimintsoft.com" class="by">Kaimintsoft</a>
